...
- 框架原理：
	- Handler核心流程
		- Hanlder.postMessage -> mainLooper -> MessageQueue.enqueueMessage() -> Looper.loopOnce() -> Looper.mLogging.println(">>>>> Dispatching to xxxx") -> dispatchMessage -> Printer.println(time2)
...
sequenceDiagram
	...
	Looper.loopOnce()->Looper.mLogging.println(">>>>> Dispatching to xxxx")
	Looper.mLogging.println(">>>>> Dispatching to xxxx")->dispatchMessage
